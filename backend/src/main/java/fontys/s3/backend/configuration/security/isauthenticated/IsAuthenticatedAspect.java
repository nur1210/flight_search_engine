package fontys.s3.backend.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@within(fontys.s3.backend.configuration.security.isauthenticated.IsAuthenticated)")
